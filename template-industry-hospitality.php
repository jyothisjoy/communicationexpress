<?php
/*
Template Name: Industry Hospitality
              ...
              <div class="container">
                    ...
                    if (isset($middleGrid2)) {
                      for ($v = 1; $v <= count($middleGrid2); $v++) {
                        ...
                        if (($middleGridcontent2['title'] != "")) {
                          // echo comm_express_kses($middleGridcontent2);
                          ?>
                      ...
                      if (isset($solutions) && $solutions['title'] != "") {
                        ...
                        <div class="col-md-6 my-4 ">
                          <div class="solutionsgrid">
                            <img class="twocolumnimg"
                              src="<?php echo esc_url(empty($solutions['image_icon']) ? "" : $solutions['image_icon']['url']); ?>" />
                            <div class="solutionheader mt-3">
                ...
                <div id="downloads" class="tab-content">
                  ...
                  for ($s = 1; $s <= 14; $s++) {
                    ...
                    if (isset($downloadGroupTop) && $downloadGroupTop['title'] != "") { ?>
