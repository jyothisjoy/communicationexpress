...
<div class="singular-main-block container">
	<div class="flex-row-d row px-2">
		...
		<div class="col-md-9 p-3">
			<div class="secondrow a <?php echo $comm_express_sidebar_column_class; ?>">
				 ...
				 */
				// Intentionally suppressed by theme; do not re-enable without coordinating with the custom product-sidebar layout.
