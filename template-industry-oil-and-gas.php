<?php
/*
Template Name: Industry Oil and Gas
              ...
              <div class="container">
                ...
                <div id="components" class="tab-content active">
                  <?php if ($collaborative_devices_title != ""): ?>
                    <div class="collaborative-devices text-center"><?php echo comm_express_kses($collaborative_devices_title); ?></div>
                  <?php endif; ?>
                  ...
                  <div class="row justify-content-start my-5 d-in-flex">
                    <?php
                    $middleGrid = get_field("middle_block_second_section");
                    if (isset($middleGrid)) {
                      for ($v = 1; $v <= count($middleGrid); $v++) {
                        $middleGridcontent = $middleGrid['content_' . $v];
                        if (($middleGridcontent['title'] != "")) {
                  ...
                  <div class="row justify-content-start my-5 d-in-flex">
                    <?php
                    $middleGrid = get_field("middle_block_third_section");
                    if (isset($middleGrid)) {
                      for ($v = 1; $v <= count($middleGrid); $v++) {
                        $middleGridcontent = $middleGrid['content_' . $v];
                        if (($middleGridcontent['title'] != "")) {
                  ...
                  <?php for ($a = 7; $a <= 8; $a++) {
                    ...
                    if (isset($componentitems) && $componentitems["com_title"] != "") {
                      ...
                      <div class="row justify-content-start my-5 d-in-flex">
                        ...
                        <?php if ($componentitems['com_image'] != ""): ?>
                          <div
                            class="astro25image col-md-6 <?php echo $componentitems["com_image_position"] == "Left" ? 'order-1' : 'order-2'; ?>">
                           <div class="astro25image"> <img src="<?php echo esc_url($componentitems['com_image']['url']); ?>" />
                          </div>
                        <?php endif; ?>
                        <div
                          class="col-md-6 <?php echo $componentitems["com_image_position"] == "Left" ? 'order-2' : 'order-1'; ?>">
                          <div class="astro-25-header">
                            <?php echo comm_express_kses($componentitems["com_title"]); ?>
                          </div>
                          <div class="astro-25-desc">
                  ...
                  <div class="row justify-content-start my-5 d-in-flex">
                    <?php
                    $middleGrid = get_field("middle_block_fourth_section");
                    if (isset($middleGrid)) {
                      for ($v = 1; $v <= count($middleGrid); $v++) {
                        $middleGridcontent = $middleGrid['content_' . $v];
                        if (($middleGridcontent['title'] != "")) {
