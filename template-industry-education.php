      ...
      <?php if (have_posts()): ?>
        <div class="flex-row-abd">
          ...
          while (have_posts()):
            ...
            $media_featured_image = wp_get_attachment_image_src(4186, 'large');
            ...
            <section id="tab-section">
              <div class="container">
                ...
                <div id="components" class="tab-content active">
                  ...
                  <div class="row justify-content-center my-5 d-in-flex">
                    <?php
                  ...
                  <div class="row justify-content-center my-5 d-in-flex">
                    <?php
                    $middleGrid2 = get_field("middle_block_section_2");
                    if (isset($middleGrid2)) {
                      for ($v = 1; $v <= count($middleGrid2); $v++) {
                        $middleGridcontent2 = $middleGrid2['content_' . $v];
                        if (($middleGridcontent2['title'] != "")) {
                          // echo comm_express_kses($middleGridcontent);
                          ?>
                          <div class="col-md-6 my-3 ">
                            <div class="twocolumngrid">
                              <?php if (!empty($middleGridcontent2['icon_image'])) { ?>
                                <img class="twocolumnimg"
                                  src="<?php echo esc_url(empty($middleGridcontent2['icon_image']) ? "" : $middleGridcontent2['icon_image']['url']); ?>" />
                              <?php } ?>
                              <div class="twocolumnheader mt-3">
                                <?php echo comm_express_kses($middleGridcontent2['title']); ?>
                              </div>
                              <div class="twocolumndesc">
                                <?php echo comm_express_kses($middleGridcontent2['description']); ?>
                              </div>

                              <a class="twocolumnurl"
                                href="<?php echo esc_url(empty($middleGridcontent2['read_more_link']) ? "" : $middleGridcontent2['read_more_link']['url']); ?>">Know
                                More</a>
                            </div>
                          </div>
                        <?php }
                  ...
                  <div class="row justify-content-center my-5 d-in-flex">
                    <?php
                    $middleGrid = get_field("communication_section");
                    if (isset($middleGrid)) {
                      $title = $middleGrid["title"];
                      ?>
                      <div class="col-md-12">
                        <h2 class="text-center font-weight-bold" style="font-size:42px;"><?php echo comm_express_kses($title); ?> </h2>
                      </div>
                      <?php for ($v = 1; $v <= count($middleGrid) - 1; $v++) {
                        $middleGridcontent = $middleGrid['content_' . $v];
                        if (($middleGridcontent['title'] != "")) {
                          // echo comm_express_kses($middleGridcontent);
                          ?>
                          <div class="col-md-4 my-3">
                            <div class="twocolumngrid communicationsection">
                              <?php if (!empty($middleGridcontent['icon_image'])) { ?>
                                <img class="twocolumnimg"
                                  src="<?php echo esc_url(empty($middleGridcontent['icon_image']) ? "" : $middleGridcontent['icon_image']['url']); ?>" />
                              <?php } ?>
                  ...
                  <div class="row black-container my-5 p-1 rounded">
                    <div class="row m-3">
                      ...
                      if (isset($solutions) && $solutions['title'] != "") {
                        ...
                        <div class="col-md-4 my-4 ">
                          <div class="solutionsgrid">
                            ...
                            <div class="solutiongridcontent mt-3">
