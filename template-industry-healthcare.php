                          ...
                          <div class="solutionsgrid">
                            ...
                            <?php if (!empty($solutions['readmore_link'])) { ?>
                              <a href="<?php echo esc_url(empty($solutions['readmore_link']) ? '' : $solutions['readmore_link']['url']); ?>"
                                class="read-more"><?php echo empty($solutions['readmore_text']) ? 'Read more' : $solutions['readmore_text']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      <?php }
                  ...
                  for ($s = 1; $s <= 14; $s++) {
                    ...
                    if ($downloadGroupTop['title'] != "") { ?>
                      <div class="downloadsection mb-3">
                        ...
                        <div class="case-studies"><?php echo isset($downloadGroupTop) ? $downloadGroupTop['title'] : "" ?></div>
